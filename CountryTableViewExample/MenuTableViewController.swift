...
class MenuTableViewController: UITableViewController {
    ...
    var friendsName = ["Abhishek", "Roney", "Mack"]
    var collegeName = ["Lambton","Sheridan","UoT","McMaster"]
    var sectionTitles = ["Countries","Friends","Education", "Institute"]
    var data = [0 : ["Canada","India"],
                1 : ["Abhishek","Roney","Mack"],
                2:  ["Lambton","Sheridan","UoT","McMaster"]]
